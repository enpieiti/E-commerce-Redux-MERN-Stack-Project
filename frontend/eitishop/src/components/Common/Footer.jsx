...
import { resetNewsletterState, subscribeNewsletter } from "../../redux/slices/newsletterSlice";

const Footer = () => {
  const dispatch = useDispatch();
  const { success, error } = useSelector((state) => state.newsletter);
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 lg:px-0">
        <div>
          ...
          <form className="flex" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="bg-primary text-white px-6 py-3 text-sm rounded-r-md hover:bg-[#666666] transition-all"
            >
              Subscrib
            </button>
          </form>
