      ...
      {selectedProduct && (
        <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg">
          <div className="flex flex-col md:flex-row">
            <div className="flex flex-col md:flex-row">
              {/* Thumbnails */}
              <div className="order-2 md:order-1 flex overflow-x-auto md:flex-col md:overflow-visible space-x-4 md:space-x-0 md:space-y-4 md:mr-6 mb-4 md:mb-0">
            ...
            <div className="md:w-1/2 md:ml-10">
              ...
              <button
                ...
                className={`bg-primary text-white py-2 px-6 rounded w-full mb-4 ${
                  isButtonDisabled ? "cursor-not-allowed" : "hover:bg-secondary"
                }`}
              >
